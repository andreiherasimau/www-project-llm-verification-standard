...
| - | ---------- | -- | -- | -- |
| 7.1 | Ensure that all third-party LLM components are acquired from a trusted source. | ✓ | ✓ | ✓ |
| 7.2 | Utilize Software Composition Analysis (SCA) tools to identify and remediate known vulnerabilities within third-party components used in LLM-powered applications. |      | ✓ | ✓ |
...
| 7.7 | Make sure third-party components are aware of possible LLM vulnerabilities and employ mitigations against possible attacks. |      | ✓ | ✓ |
